...
% figure is drawn
tmpfilename = 'figbaseline_youngshields';
...
title({'COVID-19 Epidemic - High Scenario - Shields Ages 20-60';'Asymptomatic incidence $p=0.9$, ${\cal{R}}_0=2.59$'},'fontsize',18,'interpreter','latex')
ylim([0 3]);
