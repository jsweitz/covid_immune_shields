...
% figure is drawn
tmpfilename = 'figbaseline_youngshields_v2';
...
pars.beta_a=2.5/10;   % Transmission for asymptomatic
pars.beta_s=5/10;      % Transmission for symptomatic
...
tmpval = pars.beta_a/pars.beta_s*pars.p/(1-pars.p)*(pars.r+pars.gamma_s)/(pars.r+pars.gamma_a);
...
outbreak.y0(3)=outbreak.y0(3)-10000; 
outbreak.y0(23)=9500;
outbreak.y0(33)=500;
...
[t,y]=ode45(@stir_model_youngshields,[0:1:outbreak.pTime], outbreak.y0,opts,pars,agepars);
...
[th,yh]=ode45(@stir_model_youngshields,[0:1:outbreak.pTime], outbreak.y0,opts,pars,agepars);
...
pars.alpha=0;
[tb,yb]=ode45(@stir_model_youngshields,[0:1:outbreak.pTime], outbreak.y0,opts,pars,agepars);
% Stats
...
title({'COVID-19 Epidemic - Low Scenario - Shields Ages 20-60';'Asymptomatic incidence $p=0.9$, ${\cal{R}}_0=1.85$'},'fontsize',18,'interpreter','latex')
ylim([0 3]);
